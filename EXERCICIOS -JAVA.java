...
public class CalcularVitorias {
    public static void main(String[] args) {
        ...
        int pontosNecessarios = pontosLider - pontosLanterna;
        int vitoriasNecessarias = (int) Math.ceil(pontosNecessarios / 3.0); // arredondar para cima
...
public class CalcularITBI {
    public static void main(String[] args) {
        double valorTransacao = Double.parseDouble(JOptionPane.showInputDialog("Digite o valor da transação:"));
        double valorVenal = Double.parseDouble(JOptionPane.showInputDialog("Digite o valor venal do imóvel:"));
        double percentualImposto = Double.parseDouble(JOptionPane.showInputDialog("Digite o percentual de imposto:"));
        
        double maiorValor = Math.max(valorTransacao, valorVenal);
        double valorImposto = maiorValor * percentualImposto / 100;
        
        JOptionPane.showMessageDialog(null, "O valor do imposto a ser pago é: R$ " + valorImposto);
    }
}
